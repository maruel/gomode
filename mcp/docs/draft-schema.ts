// Processed copy of the upstream Model Context Protocol draft TypeScript schema.
//
// Source: schema/draft/schema.ts from modelcontextprotocol/modelcontextprotocol
// Upstream commit: 1304c8fe5f079358a0ff22b6afdb675dc96d75d1
// Processing: source metadata header added; schema contents below are copied verbatim.
